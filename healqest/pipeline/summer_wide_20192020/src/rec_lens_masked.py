...
file_almbar1 = file_cinv.format(lminT=lminT,lmaxT=lmaxT,seed=seed1,runname=runname,rectype=rectype)
file_almbar2 = file_cinv.format(lminT=lminT,lmaxT=lmaxT,seed=seed2,runname=runname,rectype=rectype)
